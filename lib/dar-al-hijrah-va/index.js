...
exports.run = async () => {
  ...
  results[0].fajrIqama = $('#dailyprayertime-5 > table > tbody > tr:nth-child(3) > td.jamah').text()
  results[0].zuhrIqama = $('#dailyprayertime-5 > table > tbody > tr:nth-child(5) > td.jamah').text()
  results[0].asrIqama = $('#dailyprayertime-5 > table > tbody > tr:nth-child(6) > td.jamah').text()
  results[0].maghribIqama = $('#dailyprayertime-5 > table > tbody > tr:nth-child(7) > td.jamah').text()
  results[0].ishaIqama = $('#dailyprayertime-5 > table > tbody > tr:nth-child(8) > td.jamah').text()
  results[0].juma1 = j[0]
  results[0].juma2 = j[1]
  results[0].juma3 = j[2]
