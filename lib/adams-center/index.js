...
exports.run = async () => {
  ...
  // salah times
  const s = [
    $s('#wp-calendar > tbody > tr:nth-child(1) > td:nth-child(3)').first().text(),
    $s('#wp-calendar > tbody > tr:nth-child(3) > td:nth-child(3)').first().text(),
    $s('#wp-calendar > tbody > tr:nth-child(4) > td:nth-child(3)').first().text(),
    $s('#wp-calendar > tbody > tr:nth-child(5) > td:nth-child(3)').first().text(),
    $s('#wp-calendar > tbody > tr:nth-child(6) > td:nth-child(3)').first().text()
  ]
