...
exports.run = async () => {
  ...
  results[0].zuhrIqama = $('div.salah-times > div:nth-child(2) > p:nth-child(2)').text().trim()
  results[0].asrIqama = $('div.salah-times > div:nth-child(2) > p:nth-child(3)').text().trim()
  results[0].maghribIqama = $('div.salah-times > div:nth-child(2) > p:nth-child(4)').text().trim()
  results[0].ishaIqama = $('div.salah-times > div:nth-child(2) > p:nth-child(5)').text().trim()
