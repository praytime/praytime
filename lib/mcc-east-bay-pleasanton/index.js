  ...
  return [
    {
      ...
      fajrIqama: $("th:contains('Fajr') ~ td.jamah").text().trim(),
      zuhrIqama: $("th:contains('Zuhr') ~ td.jamah").text().trim(),
      asrIqama: $("th:contains('Asr') ~ td.jamah").text().trim(),
      maghribIqama: $("th:contains('Maghrib') ~ td.jamah").text().trim(),
      ishaIqama: $("th:contains('Isha') ~ td.jamah").text().trim(),
