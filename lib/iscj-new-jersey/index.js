...
exports.run = async () => {
  ...
  results[0].asrIqama = $('#panel-329-1-3-1 > div > table > tbody > tr:nth-child(6) > td.jamah').text().match(/\d{1,2}:\d{2}/)[0]
  results[0].maghribIqama = $('#panel-329-1-3-1 > div > table > tbody > tr:nth-child(7) > td.jamah').text().match(/\d{1,2}:\d{2}/)[0]
  results[0].ishaIqama = $('#panel-329-1-3-1 > div > table > tbody > tr:nth-child(8) > td.jamah').text().match(/\d{1,2}:\d{2}/)[0]
