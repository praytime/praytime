...
exports.run = async () => {
  const da = await Promise.all([
    util.loadJson(util.strftime('https://aleemstudio.com/MobileDeviceSupport/GetIqamahTimings?id=HOOVER&month=%m&day=%d', ids[0])),
    util.loadJson(util.strftime('https://aleemstudio.com/MobileDeviceSupport/GetIqamahTimings?id=HOMEWOOD&month=%m&day=%d', ids[1])),
    util.loadJson(util.strftime('https://aleemstudio.com/MobileDeviceSupport/GetIqamahTimings?id=WESTSIDE&month=%m&day=%d', ids[2])),
    util.loadJson('https://beta.aleemstudio.com/api/mobile/GetNearestJumuahScheduleV3/a8aea7e2-b39b-4b54-b791-63aa9fb2446a')
  ])
