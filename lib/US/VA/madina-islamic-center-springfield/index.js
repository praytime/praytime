...
exports.run = async () => {
  ...
  try {
    ...
    await page.goto('https://mawaqit.net/en/m/madina-springfield?showNotification=0&showSearchButton=0&showFooter=0&showFlashMessage=0', { waitUntil: 'networkidle0' })
