...
exports.run = async () => {
  ...
  util.setJumaTimes(ids[0], util.mapToText($, 'h2:contains("Township") ~ h3:contains("Khutba")').map(util.extractTimeAmPm))
  util.setJumaTimes(ids[1], util.mapToText($, 'h2:contains("Downtown") ~ h3:contains("Khutba")').map(util.extractTimeAmPm))
