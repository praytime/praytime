...
exports.run = async () => {
  ...
  ids[0].fajrIqama = timings.Fajar
  ids[0].zuhrIqama = timings.Zuhar
  ids[0].asrIqama = timings.Asr
  ids[0].maghribIqama = timings.Maghrib
  ids[0].ishaIqama = timings.Isha
  ids[0].juma1 = timings.Jumma1Adhan
  ids[0].juma2 = timings.Jumma2Adhan
