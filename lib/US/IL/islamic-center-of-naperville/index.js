  ...
  return [
    {
      ...
      juma3: $("td:contains('3rd Khutbah') ~ td").eq(0).text()
    },
    {
    ...
    },
    {
      ...
      juma1: $("td:contains('1st Khutbah') ~ td").eq(2).text(),
      juma2: $("td:contains('2nd Khutbah') ~ td").eq(2).text(),
      juma3: $("td:contains('3rd Khutbah') ~ td").eq(2).text()
    }
  ]
}
