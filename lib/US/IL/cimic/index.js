  ...
  return [
    {
      ...
      fajrIqama: $('#text-21 > div > table > tbody > tr:nth-child(2) > td:nth-child(2)').text().trim() + $('#text-21 > div > table > tbody > tr:nth-child(3) > td:nth-child(2)').text().trim(),
      ...
      maghribIqama: $('#text-21 > div > table > tbody > tr:nth-child(2) > td:nth-child(5)').text().trim() + $('#text-21 > div > table > tbody > tr:nth-child(3) > td:nth-child(5)').text().trim(),
