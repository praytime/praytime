...
exports.run = async () => {
  ...
  results[0].asrIqama = $('div.salah-times > div:nth-child(2) > p:nth-last-child(3)').text().trim()
  results[0].maghribIqama = $('div.salah-times > div:nth-child(2) > p:nth-last-child(2)').text().trim()
  results[0].ishaIqama = $('div.salah-times > div:nth-child(2) > p:nth-last-child(1)').text().trim()
