...
exports.run = async () => {
  ...
  results[0].fajrIqama = iA1.eq(0).text()
  results[0].zuhrIqama = iA1.eq(2).text()
  results[0].asrIqama = iA1.eq(3).text()
  results[0].maghribIqama = iA1.eq(4).text()
  results[0].ishaIqama = iA1.eq(5).text()
  results[0].juma1 = j1.eq(0).text()
  results[0].juma2 = j1.eq(1).text()
  results[0].juma3 = j1.eq(2).text()

  results[1].fajrIqama = iA2.eq(0).text()
  results[1].zuhrIqama = iA2.eq(2).text()
  results[1].asrIqama = iA2.eq(3).text()
  results[1].maghribIqama = iA2.eq(4).text()
  results[1].ishaIqama = iA2.eq(5).text()
  results[1].juma1 = j2.eq(0).text()
  results[1].juma2 = j2.eq(1).text()
