...
exports.run = async () => {
  const dd = await Promise.all([
    util.loadJson('https://www.masjidnow.com/api/v2/salah_timings/daily.json?masjid_id=10067'),
    util.loadJson('https://www.masjidnow.com/api/v2/salah_timings/daily.json?masjid_id=10069')
  ])
