...
exports.run = async () => {
  ...
  results[0].fajrIqama = $('.dptTimetable tr:nth-child(3) td:last-child').text()
  results[0].zuhrIqama = $('.dptTimetable tr:nth-child(5) td:last-child').text()
  results[0].asrIqama = $('.dptTimetable tr:nth-child(6) td:last-child').text()
  results[0].maghribIqama = $('.dptTimetable tr:nth-child(7) td:last-child').text()
  results[0].ishaIqama = $('.dptTimetable tr:nth-child(8) td:last-child').text()
