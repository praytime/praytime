...
exports.run = async () => {
  ...
  results[0].juma1 = $('table.prayer_table td:contains("1st Jumu") + td').text().trim()
  results[0].juma2 = $('table.prayer_table td:contains("2nd Jumu") + td').text().trim()
  results[0].juma3 = $('table.prayer_table td:contains("3rd Jumu") + td').text().trim()
