...
// }
exports.run = async () => {
  const response = await axios.get('https://muslimsalat.com/Dallas%2C+TX/daily.json?key=1b2297a8451063cfc67ad03aade14c4b')


  results[0].fajrIqama = response.data.items[0].fajr
  results[0].zuhrIqama = response.data.items[0].dhuhr
  results[0].asrIqama = response.data.items[0].asr
  results[0].maghribIqama = response.data.items[0].maghrib
  results[0].ishaIqama = response.data.items[0].isha
